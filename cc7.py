...
run("/bin/systemctl start  vsftpd.service")
...
run("/bin/systemctl start  xinetd.service")
...
run("/bin/systemctl restart  vsftpd.service")
...
run("/bin/systemctl restart  xinetd.service")
#run("service httpd restart")
run("/bin/systemctl restart  httpd.service")
